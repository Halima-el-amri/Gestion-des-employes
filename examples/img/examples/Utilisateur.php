...
<form method="post" action="modification.php">
  ...
  <div class="sidebar" data-color="purple" data-background-color="WITHE" data-image="../assets/img/sidebar-1.jpg">
 ...
 <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="ajouterUser.php">
              <i class="material-icons">person</i>
              <p>Ajouter New User</p>
            </a>
          </li>
...
<?php
  ...
  $req="INSERT INTO users (Username,Phone_number,mail,Password) ";
...
<a class="nav-link" href="DeleteUser.php?Id=<?php echo $row['Id']; ?>">Delete</a>
</td>
