...
<div class="container">
  <h2>User Profil</p></h2>
    ...
    <div class="form-group">
      ...
      <input type="email" class="form-control" id="email" placeholder="tap your mail" name="Mail"  value  ="<?php echo $Mail; ?>">
    </div>
    <div class="form-group">
...
<input  type="submit" class="btn btn-primary" href="Utilisateur.php" name="update" value="UPDATE DATA" >
